        ...
        <section class="signup">
            ...
            <div class="login-container">
                <div class="signup-content">
                    ...
                    <p style='text-align: center; color:antiquewhite;'>
                        Don't have account ? <a href="/projectApprovalSystem/studentRegistrationPage.html" class="loginhere-link" style="color:white;text-decoration:none;">Register here</a>
                        <br>
                        Email Not Verified ? <a href="/projectApprovalSystem/emailVerificationPage.php" class="loginhere-link" style="color:white;text-decoration:none;">Verify Here </a>
                    </p>
                </div>
            </div>
        </section>
