     <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <a href="/projectApprovalSystem/studentPages/approvedSubmissions.php">
                            <i class="material-icons"></i>
                            <span> Approved Submission</span>
                        </a>
                    </li>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2023-2024 <a href="javascript:void(0);"><style="color: #294861;">Project Approval System</a>.
                </div>
                <div class="version">
                    <b>Version: </b> Major Project
                </div>
            </div>
            <!-- #Footer -->
        </aside>